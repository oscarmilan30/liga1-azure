...
from ft_rendimiento_temporada import carga_final_ft_rendimiento_temporada
...
log("Inicio DDV ft_rendimiento_temporada", "INFO", "ft_rendimiento_temporada")
...
# ----------------------------------------------------------
try:
    dbutils.widgets.text("prm_pipelineid",   "28")
    ...
    log(f"Error parámetros: {e}", "ERROR", "ft_rendimiento_temporada")
...
cnt_salida  = 0
try:
    df_final = carga_final_ft_rendimiento_temporada(
    ...
    log("ft_rendimiento_temporada cargado correctamente", "SUCCESS", entity_name)
except Exception as e:
...
log("Fin DDV ft_rendimiento_temporada", "INFO", entity_name)
