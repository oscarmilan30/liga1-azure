...
from utils_liga1 import get_dbutils, get_abfss_path, read_parquet_adls, write_parquet_adls, is_dataframe_empty,get_pipeline_params,log
...
try:
    ...
    prm_capa_rdv = dict_params["CAPA_RDV"]
...
# ----------------------------------------------------------
ruta_origen = f"{prm_capa_rdv}/{prm_nombre_archivo}/stg/{prm_nombre_archivo}/data"
ruta_destino = f"{prm_capa_rdv}/{prm_nombre_archivo}/data"
