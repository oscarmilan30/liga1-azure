...
-- Catálogo principal
CREATE CATALOG IF NOT EXISTS catalog_liga1_prod
  COMMENT 'Catálogo principal Liga 1 Perú Data Platform';

-- Schemas UDV
CREATE SCHEMA IF NOT EXISTS catalog_liga1_prod.tb_udv
  COMMENT 'Unified Data Vault — tablas Delta integradas';
CREATE SCHEMA IF NOT EXISTS catalog_liga1_prod.vw_udv
  COMMENT 'Vistas UDV expuestas';

-- Schemas DDV
CREATE SCHEMA IF NOT EXISTS catalog_liga1_prod.tb_ddv
  COMMENT 'Delivery Data Vault — Data Marts Delta para BI';
CREATE SCHEMA IF NOT EXISTS catalog_liga1_prod.vw_ddv
  COMMENT 'Vistas DDV expuestas a Power BI y Delta Sharing';

-- Schema shared (para librería wheel)
CREATE SCHEMA IF NOT EXISTS catalog_liga1_prod.shared
