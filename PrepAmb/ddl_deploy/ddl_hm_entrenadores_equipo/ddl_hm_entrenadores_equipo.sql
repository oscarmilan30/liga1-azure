...
USING delta
LOCATION 'abfss://${container_name}@${storage_account}.dfs.core.windows.net/${ruta_base}/udv/md_entrenadores/data'
...
CREATE OR REPLACE TABLE ${catalog_name}.tb_udv.hm_entrenadores_equipo (
  ...
  tiempo_en_cargo       STRING             COMMENT 'Tiempo en el cargo en días (sin sufijo)',
...
LOCATION 'abfss://${container_name}@${storage_account}.dfs.core.windows.net/${ruta_base}/udv/hm_entrenadores_equipo/data'
