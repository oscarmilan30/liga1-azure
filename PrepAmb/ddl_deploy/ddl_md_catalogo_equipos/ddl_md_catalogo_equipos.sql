...
CREATE OR REPLACE TABLE ${catalog_name}.tb_udv.md_catalogo_equipos (
  ...
  nombre_fotmob_clasificacion string COMMENT 'Nombre del equipo en tablas de clasificación FotMob',
  nombre_fotmob_clas_alt string COMMENT 'Nombre alternativo usado por FotMob en clasificación (variantes históricas)',
...
USING delta
LOCATION 'abfss://${container_name}@${storage_account}.dfs.core.windows.net/${ruta_base}/udv/md_catalogo_equipos/data'
