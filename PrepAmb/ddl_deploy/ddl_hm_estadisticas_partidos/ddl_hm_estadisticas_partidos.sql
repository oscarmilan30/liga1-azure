...
CREATE OR REPLACE TABLE ${catalog_name}.tb_udv.hm_estadisticas_partidos (
  ...
  posesion_local               INT     COMMENT 'Porcentaje de posesión del equipo local (valor entero, ej. 64).',
  posesion_local_pct           DOUBLE  COMMENT 'Posesión del local como proporción (0–1), ej. 0.64.',
  posesion_visitante           INT     COMMENT 'Porcentaje de posesión del equipo visitante.',
  posesion_visitante_pct       DOUBLE  COMMENT 'Posesión del visitante como proporción (0–1).',
  centros_precisos_local       INT     COMMENT 'Centros precisos realizados por el equipo local (Accurate crosses en FotMob).',
  centros_precisos_visitante   INT     COMMENT 'Centros precisos realizados por el equipo visitante (Accurate crosses en FotMob).',
  bloqueos_local               INT     COMMENT 'Bloqueos realizados por el equipo local (Blocks en FotMob).',
  bloqueos_visitante           INT     COMMENT 'Bloqueos realizados por el equipo visitante (Blocks en FotMob).',
...
LOCATION 'abfss://${container_name}@${storage_account}.dfs.core.windows.net/${ruta_base}/udv/hm_estadisticas_partidos/data'
