...
CREATE OR REPLACE TABLE ${catalog_name}.tb_udv.md_plantillas (
  ...
  edad              STRING COMMENT 'Edad actual de jugador',
  nacionalidad      STRING COMMENT 'Nacionalidad del jugador',
  altura            STRING COMMENT 'Altura del jugador',
  pie               STRING COMMENT 'Pierna hábil del jugador',
  valor_mercado     STRING COMMENT 'Valor de mercado según fuente',
...
CREATE OR REPLACE TABLE ${catalog_name}.tb_udv.hm_plantillas_equipo (
  ...
  fecha_fichaje     STRING COMMENT 'Fecha de fichaje con el equipo',
